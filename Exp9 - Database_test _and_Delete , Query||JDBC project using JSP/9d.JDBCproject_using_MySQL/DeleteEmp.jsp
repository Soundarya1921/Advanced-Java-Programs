/*9d. Develop a JDBC project using MySQL to delete the records in the table Emp of the databasevEmployee by getting the name starting with ‘S’ through keyboard and Generate the report as
